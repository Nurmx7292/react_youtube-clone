  ...
  return (
    <div className={classes.videoPlayer}>
      ...
      <div className={classes["video-info"]}>
        <div className={classes["video-views"]}>123k views</div>
        <div className={classes["video-controls"]}>
          <Button icon={"assets/Like.svg"} text={"123k"} />
          <Button icon={"assets/Dislike.svg"} text={"435k"} />
          <Button icon={"assets/Share.svg"} text={"Share"} />
        </div>
        <button className={classes["mobile-more-button"]}>
          <img src="assets/More2.svg" alt="#" />
        </button>
      </div>
      <div className={classes["channel-card"]}>
        ...
        <div className={classes["channel-info"]}>
          ...
          <div
            className={`${classes["sub-amount-mobile"]} ${classes["video-views"]}`}
          >
            245K subscribed
          </div>
          <div className={classes["publish-date"]}>
